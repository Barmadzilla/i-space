    ...
    return {
      ...
      events: [
        ...
        },
        {
          ...
          date: '01.02.2021',
          content: 'Кошелёк — приложение для хранения банковских и дисконтных карт. Мы начали год с нового достижения: показатель MAU превысил 10 млн пользователей. За последние пару лет наша команда выросла вдвое...',
