  ...
  data() {
    return {
      ...
      processes: {
        ...
        processes: [
          'Все дела решаем в едином чате. Здесь вы, менеджер и специалисты по направлениям.',
          'Если задачу проще объяснить конкретному специалисту — добавляем его в чат.',
          'Реагируем на задачу в чате за 2 часа и отправляем её подходящему сотруднику.'
        ]
      }
    }
  }
